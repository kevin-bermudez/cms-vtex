...
module.exports = (function( cms_vtex_general,general_account,general_config ){
	...
	if(exist_config){
		...
		/*if(typeof data_tmp_json.auto === 'undefined' || data_tmp_json.dest_auto == 'auto'){
			file_config_prev = data_tmp_json;
		}
		else{
			name_file_def = JSON.parse(fs.readFileSync( name_file_config,'utf8' ) ).auto
			file_config_prev = JSON.parse( fs.readFileSync( name_file_def,'utf8' ) );
		}*/
